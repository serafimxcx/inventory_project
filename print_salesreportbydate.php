...
$loadstocks .= '<br><h1 style="text-align:center;">Sales Report
                <br><span class="txt_date">' . $start_date .' to '. $end_date .'</span></h1><br>';
